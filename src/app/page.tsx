...
const Home = () => {
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="bg-[#F5F5DC] text-[#151414] p-8 text-center">
        <h1 className="text-5xl font-bold">Welcome to the Story Books Blog</h1>
        <p className="mt-4 text-lg">Explore a collection of inspiring Story Books, reviews, and discussions.</p>
      </section>

      {/* Novels Collection */}
      <div className="space-y-8 px-6 sm:px-12">
        <h2 className="text-4xl font-bold text-[#070606] mt-6">Books Collection</h2>
